...
# 🎯 Task Overview
Create the DraftReviewAgent that uses AutoGen to critique drafts in isolation and return JSON diffs of suggested edits, providing comprehensive draft analysis and quality scoring.
...
### Related Task Files:
- **Source Task**: `.taskmaster/tasks/task_006.txt`
- **Context File**: `.taskmaster/context/task_006/task.md`
